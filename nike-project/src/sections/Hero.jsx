    ...
    <section 
      ...
      gap-10 max-container">
        ...
        justify-center items-start w-full max-xl:padding-x pt-28'>
          ...
          <p className="font-montserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover soma new stylish Nike arrivals to live a more active and healthy life</p>
        ...
        <div className='relative flex-1 flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-cover bg-center'>
          ...
          <div className='flex border-2 sm:gap-6 gap-4 absolute -bottom-[5%] sm:left-[10%] max-sm:px-6'>
            {shoes.map((shoe) => (
              <div key="shoe">
