    ...
    <footer className='max-container'>
      <div className='flex justify-between items-start flex-wrap max-lg:flex-col'>
         <div className='flex flex-col items-start'>
          ...
          <p className='mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm'> Get shoes ready for your new term at the nearest Nike store. Find your perfect size. Get rewards.</p>
